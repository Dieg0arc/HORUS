...
model = YOLO('/home/srm/Documents/hands-pose-estimation/runs/segment/train3/weights/best.pt')  # Asegúrate de que best.pt esté en la misma carpeta o especifica la ruta completa
